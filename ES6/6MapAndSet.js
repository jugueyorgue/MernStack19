...
let myMap3 = new Map();
myMap3.set("firstname", "jugue");
myMap3.set("lastname", "Nkuzu");
myMap3.set("age", 20);
 ...
 let myMap1 = new Map();
 let keyObj1 = {}, keyNum1 = 1;

myMap1.set(keyObj1, "this is an object")
myMap1.set(keyNum1, "this is a number")
console.log(myMap1.size)
console.log(myMap1.entries())

// and a list of unique names of 10 states of your favrourite country you wish to visit on world tour

let states=new Set(["Virginia","New york","Maine","Texas","New Jersey","Ohio","Maryland","Connecticut"]);
