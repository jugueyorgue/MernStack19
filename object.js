...
var Employee = {
    ...
    GetEmployeeInfo : function () { // `` - template literal easy way of writing string and its concatenetion
        return `
                    ...
                    ${this.Salary}
                `
                // instaed of `` we can use the below statement:
...
//Address2.ssn = 86578354 

// in this case ,console.log(DispatchItem) will not get the Address2.ssn = 86578354 as it has been added after creating merge object DispatchItem = Object.assign(User, Address, Address2)
