//defines student actions which contains action type and payload for each action creator to dispatch to store
import * as actionTypes from "../ActionTypes";
import axios from "axios";

//action accepts payload value/object to be used in student reducer switch
...
export const SaveStudentToDBUsingFetch = (studentObj)=>{
    ...
    return (dispatch)=>{
        window.fetch("http://localhost:9000/student/apistudent/signinup",
            {
                method: 'POST',
                headers: {
...
export const SaveStudentToDBUsingAxios = (studentObj)=>{
    ...
    return (dispatch)=>{
        axios.post("http://localhost:9000/student/apistudent/signinup",//uri or end point of singninup api
